//Je vais récuperer les valeurs de champs de la modal
...
document.getElementById("fumeursInput").value = fumeurs
document.getElementById("animauxInput").value = animaux
document.getElementById("musicInput").value = music
document.getElementById("speakInput").value = speak
